...
public class Double_room extends Room {
	...
	public Double_room(String id, String m2, String capacity, Boolean available, Boolean wifi, Fecha f_inicio,
			Fecha f_fin, Boolean tv, Boolean bed_type, Boolean spa, Fecha start_date_spa,
			Fecha end_date_spa) {
